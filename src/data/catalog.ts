...
const importedConceptSeeds = dedupeEssaySeeds(buildImportedConceptSeeds());
const conceptSeeds: EssaySeed[] =
  importedConceptSeeds.length > 0 ? importedConceptSeeds : [];
...
const importedGlossarySeeds = dedupeGlossarySeeds(buildImportedGlossarySeeds());
const glossarySeeds: GlossarySeed[] =
  importedGlossarySeeds.length > 0 ? importedGlossarySeeds : [];
